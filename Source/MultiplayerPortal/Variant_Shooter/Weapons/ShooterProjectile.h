 ...
 */
UCLASS(abstract)
class MULTIPLAYERPORTAL_API AShooterProjectile : public AActor, public ITeleportable
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere, Category="Projectile|Hit", meta = (ClampMin = 0, ClampMax = 500))
